...
(function() {
    ...
    //						rgb colors f33 = f  100% red   3 20% green 3 20% blue
    // Piano colors								
    //

    var colors = '33f 3f3 f33 ff3 f3f 3ff'.split(' '),
        curColor = 0;
	...
	var pianocolors = 'ff0000 00ff00 0000ff ff3333 ffff00 ff6600'.split(' ')
	currColor = 0		
	
	$(document).ready(function(){
		$("#btncolor").click(function(){					
			if (++currColor >= pianocolors.length) currColor = 0;
            document.getElementById('piano').style.backgroundColor = '#' + pianocolors[currColor];
			
			//document.getElementById('piano').style.backgroundColor = '#ff3';      
		});
	});
	...
	*/
	...
	// clearTimeout 1000 changed to 500
	
    window.setTimeout(function() {
        $help.removeClass('show');
    }, 100);
	
	// timer 700 changed to 100
